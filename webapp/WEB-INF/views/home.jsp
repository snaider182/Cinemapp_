      ...
      <div id="myCarousel" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
          <div class="item active">         
            <img src="${urlPublic}/imagenes/slide1.jpg" alt="Slide" title="Some text" >
          </div>
          <div class="item">         
            <img src="${urlPublic}/imagenes/slide2.jpg" alt="Slide" title="Some text" >
          </div>
          <div class="item">         
            <img src="${urlPublic}/imagenes/slide3.jpg" alt="Slide" title="Some text" >
          </div>
          <div class="item">         
            <img src="${urlPublic}/imagenes/slide4.jpg" alt="Slide" title="Some text" >
          </div>
        </div>
      ...
      <div class="container marketing">
        ...
        <div class="row">
          ...
          <div class="col-xs-12 col-sm-6 col-md-3">
            <img class="img-rounded" src="${urlPublic}/imagenes/estreno1.png" alt="Generic placeholder image" width="150" height="200">
          ...
          <div class="col-xs-12 col-sm-6 col-md-3">
            <img class="img-rounded" src="${urlPublic}/imagenes/estreno2.png" alt="Generic placeholder image" width="150" height="200">
          ...
          <div class="col-xs-12 col-sm-6 col-md-3">
            <img class="img-rounded" src="${urlPublic}/imagenes/estreno3.png" alt="Generic placeholder image" width="150" height="200">
            <h4>Fragmentado</h4>
            <h4>
          ...
          <div class="col-xs-12 col-sm-6 col-md-3">
            <img class="img-rounded" src="${urlPublic}/imagenes/estreno4.png" alt="Generic placeholder image" width="150" height="200">
